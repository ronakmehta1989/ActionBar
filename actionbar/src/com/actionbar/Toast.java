...
public class Toast extends android.widget.Toast {
    ...
    private static final String TAG = "ActionBarToast";
	
	/** Holo theme from HoloEverywhere framework. Cut by STALKER_2010
     */
    ...
    public void setText(CharSequence s) {
        ...
        try {
            ...
            Log.e(Toast.TAG, "This Toast was not created with Toast.makeText", e);
        }
    }
}
